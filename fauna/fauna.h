...
extern "C" FAUNA_DECLSPEC int fauna_write_bin_deviceInfo(std::string& path);
...
extern "C" FAUNA_DECLSPEC int fauna_write_json_streamInfo(std::string& path);
extern "C" FAUNA_DECLSPEC int fauna_read_json_streamInfo(std::string& path);
...
extern "C" FAUNA_DECLSPEC int fauna_mmap_buffer(std::string& path);
extern "C" FAUNA_DECLSPEC int fauna_mmap_bufferInfo(std::string& path);
